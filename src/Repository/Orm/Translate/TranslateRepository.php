...
namespace Evrinoma\TranslateBundle\Repository\Orm\Translate;
...
class TranslateRepository extends RepositoryWrapper implements TranslateRepositoryInterface, RepositoryWrapperInterface
{
